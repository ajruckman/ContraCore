...
type Config struct {
	...
	Sources        types.StringArray `boil:"sources" json:"sources" toml:"sources" yaml:"sources"`
	SearchDomains  types.StringArray `boil:"search_domains" json:"search_domains" toml:"search_domains" yaml:"search_domains"`
	DomainNeeded   bool              `boil:"domain_needed" json:"domain_needed" toml:"domain_needed" yaml:"domain_needed"`
	SpoofedA       string            `boil:"spoofed_a" json:"spoofed_a" toml:"spoofed_a" yaml:"spoofed_a"`
	SpoofedAaaa    string            `boil:"spoofed_aaaa" json:"spoofed_aaaa" toml:"spoofed_aaaa" yaml:"spoofed_aaaa"`
	SpoofedCname   string            `boil:"spoofed_cname" json:"spoofed_cname" toml:"spoofed_cname" yaml:"spoofed_cname"`
	SpoofedDefault string            `boil:"spoofed_default" json:"spoofed_default" toml:"spoofed_default" yaml:"spoofed_default"`
...
var ConfigColumns = struct {
	...
	SpoofedA:       "spoofed_a",
	SpoofedAaaa:    "spoofed_aaaa",
	SpoofedCname:   "spoofed_cname",
	SpoofedDefault: "spoofed_default",
}
...
var ConfigWhere = struct {
	ID             whereHelperint
	Sources        whereHelpertypes_StringArray
	SearchDomains  whereHelpertypes_StringArray
	DomainNeeded   whereHelperbool
	SpoofedA       whereHelperstring
	SpoofedAaaa    whereHelperstring
	SpoofedCname   whereHelperstring
	SpoofedDefault whereHelperstring
}{
	ID:             whereHelperint{field: "\"config\".\"id\""},
	Sources:        whereHelpertypes_StringArray{field: "\"config\".\"sources\""},
	SearchDomains:  whereHelpertypes_StringArray{field: "\"config\".\"search_domains\""},
	DomainNeeded:   whereHelperbool{field: "\"config\".\"domain_needed\""},
	SpoofedA:       whereHelperstring{field: "\"config\".\"spoofed_a\""},
	SpoofedAaaa:    whereHelperstring{field: "\"config\".\"spoofed_aaaa\""},
	SpoofedCname:   whereHelperstring{field: "\"config\".\"spoofed_cname\""},
	SpoofedDefault: whereHelperstring{field: "\"config\".\"spoofed_default\""},
}
...
var (
	configAllColumns            = []string{"id", "sources", "search_domains", "domain_needed", "spoofed_a", "spoofed_aaaa", "spoofed_cname", "spoofed_default"}
	configColumnsWithoutDefault = []string{}
	configColumnsWithDefault    = []string{"id", "sources", "search_domains", "domain_needed", "spoofed_a", "spoofed_aaaa", "spoofed_cname", "spoofed_default"}
...
func (q configQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Config, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "contradb: failed to execute a one query for config")
	}
...
func (q configQuery) All(ctx context.Context, exec boil.ContextExecutor) (ConfigSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "contradb: failed to assign all query results to Config slice")
	}
...
func (q configQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "contradb: failed to count config rows")
	}
...
func (q configQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "contradb: failed to check if config exists")
	}
...
func FindConfig(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Config, error) {
	configObj := &Config{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "contradb: unable to select from config")
	}
...
func (o *Config) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("contradb: no config provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "contradb: unable to insert into config")
	}
...
func (o *Config) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("contradb: unable to update config, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "contradb: unable to update config row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "contradb: failed to get rows affected by update for config")
	}
...
func (q configQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "contradb: unable to update all for config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "contradb: unable to retrieve rows affected for config")
	}
...
func (o ConfigSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "contradb: unable to update all in config slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "contradb: unable to retrieve rows affected all in update all config")
	}
	return rowsAff, nil
}
...
func (o *Config) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("contradb: no config provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("contradb: unable to upsert config, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "contradb: unable to upsert config")
	}
...
func (o *Config) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("contradb: no Config provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "contradb: unable to delete from config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "contradb: failed to get rows affected by delete for config")
	}
...
func (q configQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("contradb: no configQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "contradb: unable to delete all from config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "contradb: failed to get rows affected by deleteall for config")
	}
...
func (o ConfigSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "contradb: unable to delete all from config slice")
	}
...
func (o *ConfigSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "contradb: unable to reload all in ConfigSlice")
	}
...
func ConfigExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "contradb: unable to check if config exists")
	}
